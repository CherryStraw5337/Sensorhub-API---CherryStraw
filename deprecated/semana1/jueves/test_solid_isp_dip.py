...
from deprecated.semana1.jueves.solid_isp_dip import (
    DataProcessor,
    InMemoryRepository,
    SimpleADCSensor,
    SmartActuator,
)
from deprecated.semana1.lunes.modelos_sensor import Reading as SensorReading
from deprecated.semana1.lunes.modelos_sensor import SensorStatus, SensorType

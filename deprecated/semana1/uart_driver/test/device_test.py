...
from deprecated.semana1.uart_driver.config import UartConfig
from deprecated.semana1.uart_driver.device import DeviceNotConnectedError, UartDevice
from deprecated.semana1.uart_driver.parsers import NMEAParser

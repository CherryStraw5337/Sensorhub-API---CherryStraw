...
def procesar_chat(ruta_archivo, titulo_semana):
    """
    ...
    # significa que ya es un Markdown formateado. Lo unificamos directamente.
...
def main():
    ...
    for archivo, titulo in archivos_a_process.items():
